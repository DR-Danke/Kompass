...
def main():
    ...
    src_cmd = os.path.join(main_repo_root, ".claude", "commands", "prompts_to_issues.md")
    dst_cmd = os.path.join(worktree_path, ".claude", "commands", "prompts_to_issues.md")
    if os.path.exists(src_cmd) and not os.path.exists(dst_cmd):
        ...
        logger.info("Synced prompts_to_issues.md slash command into worktree")
