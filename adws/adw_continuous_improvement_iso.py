...
SCAN_ZONES: list[ScanZone] = [
    ...
    ScanZone(
        ...
        category="technical",
        glob_patterns=["backend/src/adapter/rest/*.py"],
    ),
    ScanZone(
        zone_id="backend-services",
        description="Backend business logic and service layer",
        category="technical",
        glob_patterns=["backend/src/core/servicios/*.py"],
    ),
    ScanZone(
    ...
    ScanZone(
        ...
        glob_patterns=[
            ...
            "backend/main.py",
            "backend/src/adapter/rest/dependencies.py",
            "backend/src/adapter/rest/auth_routes.py",
        ],
    ),
    ScanZone(
        ...
        category="technical",
        glob_patterns=["frontend/src/pages/**/*.tsx"],
    ),
    ScanZone(
        zone_id="frontend-components",
        description="Reusable React UI components",
        category="technical",
        glob_patterns=["frontend/src/components/**/*.tsx"],
    ),
    ScanZone(
    ...
    ScanZone(
        ...
        description="Sidebar navigation, routing, and layout",
    ...
    ScanZone(
        zone_id="ux-forms",
        description="Form components and form UX patterns",
        category="ux-business",
        glob_patterns=["frontend/src/components/forms/*.tsx"],
    ),
    ScanZone(
        zone_id="ux-data-display",
        description="Dashboards, charts, tables",
        category="ux-business",
        glob_patterns=[
    ...
    ScanZone(
        ...
        description="Login flow, role-based access, protected routes",
        category="ux-business",
        glob_patterns=[
    ...
    ScanZone(
        zone_id="ux-legal",
        description="Legal module: contracts, documents, templates",
        category="ux-business",
        glob_patterns=[
            "frontend/src/pages/legal/**/*.tsx",
            "frontend/src/components/legal/**/*.tsx",
            "frontend/src/services/legal*.ts",
        ],
    ),
    ScanZone(
        zone_id="ux-servicedesk",
        description="ServiceDesk module: tickets, technicians, analytics",
        category="ux-business",
        glob_patterns=[
            "frontend/src/pages/servicedesk/**/*.tsx",
            "frontend/src/components/servicedesk/**/*.tsx",
            "frontend/src/services/servicedesk*.ts",
        ],
    ),
    ScanZone(
        zone_id="ux-cmdb-intelligence",
        description="CMDB and RAG Intelligence modules",
        category="ux-business",
        glob_patterns=[
            "frontend/src/pages/cmdb/**/*.tsx",
            "frontend/src/pages/intelligence/**/*.tsx",
            "frontend/src/components/cmdb/**/*.tsx",
