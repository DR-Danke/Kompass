...
This script polls GitHub every 3 minutes to detect issues where 'adw_run' appears
...
def main():
    ...
    print(f"INFO: Polling interval: 3 minutes")
    ...
    schedule.every(3).minutes.do(check_and_process_issues)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ["--help", "-h"]:
        ...
        print("\nThe script will poll GitHub issues every 3 minutes and trigger")
