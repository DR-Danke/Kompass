...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    website VARCHAR(500),
    notes TEXT,
    -- Certification fields (added for Supplier Certification system)
    ...
    pipeline_status VARCHAR(50) DEFAULT 'contacted'
...
-- Supplier Audits: Factory audit documents and extracted data for supplier qualification
...
-- Add foreign key from suppliers.latest_audit_id to supplier_audits.id
-- (This is done separately because supplier_audits must exist first)
ALTER TABLE suppliers
    ADD CONSTRAINT IF NOT EXISTS fk_suppliers_latest_audit
